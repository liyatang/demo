...
restangular.provider('Restangular', function() {
  ...
  Configurer.init = function(object, config) {
    ...
    **/
    ...
    function RestangularResource(config, $http, url, configurer, $q) {
      var resource = {};
    ...
    BaseCreator.prototype.resource = function(current, $http, localHttpConfig, callHeaders, callParams, what, etag,operation, $q) {
    ...
    function createServiceForConfiguration(config) {
      ...
      function fetchFunction(what, reqParams, headers) {
        ...
        urlHandler.resource(this, $http, request.httpConfig, request.headers, request.params, what,
                this[config.restangularFields.etag], operation, $q)[method]().then(okCallback, function error(response) {
        ...
        if (config.isSafe(operation)) {
          if (isOverrideOperation) {
            urlHandler.resource(this, $http, request.httpConfig, callHeaders, request.params,
              what, etag, callOperation, $q)[callOperation]({}).then(okCallback, errorCallback);
          } else {
            urlHandler.resource(this, $http, request.httpConfig, callHeaders, request.params,
              what, etag, callOperation, $q)[callOperation]().then(okCallback, errorCallback);
          }
          ...
          urlHandler.resource(this, $http, request.httpConfig, callHeaders, request.params,
            what, etag, callOperation, $q)[callOperation](request.element).then(okCallback, errorCallback);
        }
